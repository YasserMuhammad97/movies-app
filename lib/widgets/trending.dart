            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () {
                      var namess = trending[index]['title']!=null? trending[index]['title'] :  trending[index]['original_name'];
                    ...
                    trending[index]['title']!=null?  Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(child: ModifiedText(text:trending[index]['title']!=null? trending[index]['title'] :  trending[index]['original_name'] ),)
                        ],
                      ),
                    ) : Container(),
                  );
